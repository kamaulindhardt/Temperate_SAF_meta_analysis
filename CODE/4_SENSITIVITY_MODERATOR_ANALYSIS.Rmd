...
fit_minimal_random_effects <- function(data, response, random_effects) {
  ...
  model <- tryCatch({
    rma.mv(
      ...
      random = random_effects,      # Crossed and Nested random effects
      data = data_subset,
      method = "REML",
...
# Fitting model for: Pest and Disease ...
...
#   |==================================================| 100% elapsed=01m 22s
#   |==================================================| 100% elapsed=02m 16s
# Extracting influence diagnostics for: Carbon sequestration ...
#   |==================================================| 100% elapsed=08s  
#   |==================================================| 100% elapsed=09s 
# Extracting influence diagnostics for: Product quality ...
#   |==================================================| 100% elapsed=12s  
...
exclude_responses <- c("Greenhouse gas emission", "Water quality", "Pest and disease control")
...
random_effects_formula <- list(~ 1 | id_article,                 # <----------  ! Chosen Random Effects Structure !
                               ~ 1 | location / experiment_year)
