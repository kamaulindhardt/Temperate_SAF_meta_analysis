...
# View sneak-peak
splits$non_imp_dataset$Biodiversity |> glimpse()
```
...
overlapping_studies <- all_loo_results_for_plotting %>%
...
all_loo_results_for_plotting <- all_loo_results_for_plotting %>%
  mutate(
...
# Check dimensions
dim(V_matrix_non_imp)
nrow(non_imp_dataset)

# Check if V_matrix is symmetric
is_symmetric <- all.equal(V_matrix_non_imp, t(V_matrix_non_imp))
print(is_symmetric)

# Check diagonal elements
diag_positive <- all(diag(V_matrix_non_imp) > 0)
print(diag_positive)
