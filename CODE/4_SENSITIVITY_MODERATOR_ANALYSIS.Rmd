...
significant_moderator_res_clean <- significant_moderator_res %>%
  # Rename moderators to more intuitive names
  mutate(
    Moderator = case_when(
    ...
    # Rename Interactions (Formatted with "Interaction: X x Y")
    Term = ifelse(
      str_detect(Term, ":"), 
      str_replace_all(Term, c(
        ...
        ":" = " x "  # Replace ":" with " x " for interactions
      )),
      Term
    ),

    # Ensure intercept terms are clearly labeled
