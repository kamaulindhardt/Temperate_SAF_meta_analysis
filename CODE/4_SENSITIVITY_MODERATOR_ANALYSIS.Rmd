...
# Rename to match ggplot usage
dfbetas_plot_data <- mv_influence_diagnostics_summary %>%
  mutate(Is_Influential = abs(Mean_DFBeta) > DFBeta_Threshold)
...
dfbetas_plot_data %>%
  ...
  facet_wrap(~Response_Variable, scales = "free_y", nrow = 1) +
