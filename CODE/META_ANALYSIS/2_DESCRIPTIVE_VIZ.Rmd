...
distinct_studies <- database_clean |> 
...
```{r}
# Bar plot for tree-crop combinations
database_clean_eda |> 
  ggplot(aes(x = tree_crop_combination)) +
...
database_clean_eda |> 
  ...
  facet_wrap(~ tree_crop_combination) +
...
```{r}
# Bar plot for the number of studies per location
database_clean_eda |> 
