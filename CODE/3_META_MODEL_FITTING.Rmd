...
for (response in names(v_matrices)) {
  ...
  random_effects <- list(~ 1 | id_article,                 # <----------  ! Chosen Random Effects Structure !
...
##########################################################################
# Last go (25/03-2025) 
# Total time taken: 1.211517 mins  

# Processing response variable: Biodiversity 
# Advarsel: Redundant predictors dropped from the model.Advarsel: 14 rows with NAs omitted from model fitting.Advarsel: 38 rows with NAs omitted from model fitting.Advarsel: 110 rows with NAs omitted from model fitting.Advarsel: 2 rows with NAs omitted from model fitting.Advarsel: 112 rows with NAs omitted from model fitting.Advarsel: Redundant predictors dropped from the model.Advarsel: 112 rows with NAs omitted from model fitting.Advarsel: Redundant predictors dropped from the model.
# Processing response variable: Carbon sequestration 
# Advarsel: Redundant predictors dropped from the model.Advarsel: Redundant predictors dropped from the model.Advarsel: Redundant predictors dropped from the model.Advarsel: Redundant predictors dropped from the model.Advarsel: Redundant predictors dropped from the model.Advarsel: Redundant predictors dropped from the model.Advarsel: 2 rows with NAs omitted from model fitting.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: 2 rows with NAs omitted from model fitting.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: 2 rows with NAs omitted from model fitting.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.
# Processing response variable: Product quality 
# Advarsel: Redundant predictors dropped from the model.Advarsel: 14 rows with NAs omitted from model fitting.Advarsel: 54 rows with NAs omitted from model fitting.Advarsel: 68 rows with NAs omitted from model fitting.Advarsel: Redundant predictors dropped from the model.Advarsel: 68 rows with NAs omitted from model fitting.Advarsel: Redundant predictors dropped from the model.
# Processing response variable: Crop yield 
# Advarsel: 17 rows with NAs omitted from model fitting.Advarsel: 30 rows with NAs omitted from model fitting.Advarsel: 86 rows with NAs omitted from model fitting.Advarsel: 116 rows with NAs omitted from model fitting.Advarsel: 116 rows with NAs omitted from model fitting.Advarsel: Redundant predictors dropped from the model.
# Processing response variable: Pest and Disease 
# Advarsel: Redundant predictors dropped from the model.Advarsel: 14 rows with NAs omitted from model fitting.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: 44 rows with NAs omitted from model fitting.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: 44 rows with NAs omitted from model fitting.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: 44 rows with NAs omitted from model fitting.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.
# Processing response variable: Soil quality 
# Advarsel: Ratio of largest to smallest sampling variance extremely large. May not be able to obtain stable results.Advarsel: Ratio of largest to smallest sampling variance extremely large. May not be able to obtain stable results.Advarsel: Ratio of largest to smallest sampling variance extremely large. May not be able to obtain stable results.Advarsel: Ratio of largest to smallest sampling variance extremely large. May not be able to obtain stable results.Advarsel: Ratio of largest to smallest sampling variance extremely large. May not be able to obtain stable results.Advarsel: Ratio of largest to smallest sampling variance extremely large. May not be able to obtain stable results.Advarsel: Ratio of largest to smallest sampling variance extremely large. May not be able to obtain stable results.Advarsel: 50 rows with NAs omitted from model fitting.Advarsel: Ratio of largest to smallest sampling variance extremely large. May not be able to obtain stable results.Advarsel: 188 rows with NAs omitted from model fitting.Advarsel: Ratio of largest to smallest sampling variance extremely large. May not be able to obtain stable results.Advarsel: 1 row with NAs omitted from model fitting.Advarsel: Ratio of largest to smallest sampling variance extremely large. May not be able to obtain stable results.Advarsel: 189 rows with NAs omitted from model fitting.Advarsel: Ratio of largest to smallest sampling variance extremely large. May not be able to obtain stable results.Advarsel: Redundant predictors dropped from the model.Advarsel: 189 rows with NAs omitted from model fitting.Advarsel: Ratio of largest to smallest sampling variance extremely large. May not be able to obtain stable results.Advarsel: Redundant predictors dropped from the model.
# Processing response variable: Water quality 
# Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.Advarsel: Redundant predictors dropped from the model.Advarsel: Single-level factor(s) found in 'random' argument. Corresponding 'sigma2' value(s) fixed to 0.
# All models have been saved successfully!
```
...
model_comparison$study_location_year_interaction <- rma.mv(yi = yi, V = vi,     # <------------- ! Chosen Random Effects Structure !
                                                           mods = ~ 1,
                                                           random = list(
                                                             ~ 1 | id_article,
                                                             ~ 1 | location/experiment_year
...
model_list <- list(
  ...
  "E) Nested: Study / Experiment"                         = model_comparison$study_experiment,               # <------------- ! Lowest AIC !
  ...
  "K) Crossed: Study + Location / Year (Chosen)"          = model_comparison$study_location_year_interaction, # <------------- ! Chosen Random Effects Structure !
  "L) Crossed: Study + Location + Year + Location / Year" = model_comparison$study_location_year_full
)
...
```{r}
model_comparison$study_location_year_interaction$fit.stats # <------------- ! Chosen Random Effects Structure !
...
Carbon sequestrations, pest and disease, and crop yield see the most substantial changes under the interaction model, suggesting that interactions between moderators strongly influence these variables.
...
- For certain response variables (Carbon sequestrations, crop yield, pest and disease), interactions among moderators play a crucial role, but for others, their effects remain uncertain.
