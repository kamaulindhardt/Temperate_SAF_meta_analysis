...
prep_dataset_for_rom <- function(data) {
  data %>%
    ...
    # - For variables like "Carbon sequestrations," "Pests and Diseases," and "Water quality,"
    #   lower values are considered better. We negate the mean values to reflect this correctly.
    mutate(
      silvo_mean = ifelse(response_variable %in% c("Carbon sequestration", "Pests and Diseases", "Water quality"),
                          -silvo_mean, silvo_mean),
      control_mean = ifelse(response_variable %in% c("Carbon sequestration", "Pests and Diseases", "Water quality"),
