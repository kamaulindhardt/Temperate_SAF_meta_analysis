...
# Create boxplot styled like a forest plot with custom colors
...
boxplot_raw_effect_size_zoomed <- imp_data_rom_reorder |> 
  ggplot(aes(y = response_variable, x = yi, fill = response_variable)) +
...
boxplot_raw_effect_size_zoomed
```
