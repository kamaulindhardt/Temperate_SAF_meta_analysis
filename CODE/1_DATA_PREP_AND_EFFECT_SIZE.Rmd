...
suppressWarnings({
  ...
  database <- readxl::read_excel(
    here("DATA", "META_ANALYSIS", "Meta_data_v2.xlsx"), 
...
kg_climate <- raster(here("DATA", "META_ANALYSIS", "koppen_geiger_tif", "1991_2020", "koppen_geiger_0p1.tif"))
...
```{r}
unclassified_sub_region <- database_clean |>
...
original_data_x <- non_imp_dataset %>%
...
readr::write_csv(database_clean_sd,
                 here::here("DATA", "META_ANALYSIS", "FROM_R", "non_imp_dataset.csv"))
# IMPUTED
readr::write_csv(imp_dataset,
                 here::here("DATA", "META_ANALYSIS", "FROM_R", "imp_dataset.csv"))
```
