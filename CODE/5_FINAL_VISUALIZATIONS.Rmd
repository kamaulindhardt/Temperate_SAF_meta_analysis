...
Based on the interaction_model model
...
# STEP 5
##########################################################################################################################################
FOREST PLOT (VIOLIN PLOT) EFFECT SIZES FOR ALL RESPONSE VARIABLES (THIS IS THE FINNAL FOREST PLOT)
##########################################################################################################################################
...
```{r}
evaluation_results$`Crop yield`$interaction_model
evaluation_results$`Biodiversity`$interaction_model
evaluation_results$`Soil quality`$interaction_model
```
...
back_transformed_results$`Water quality`$interaction_model
back_transformed_results$Biodiversity$interaction_model
```
