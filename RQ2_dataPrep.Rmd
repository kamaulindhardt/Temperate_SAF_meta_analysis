...
readr::write_rds(database.lat.long, "./DATASET.LOCATIONS/database.lat.long.Rds")
```

Loading dataset with lat long coordinates from local disc
```{r Loading dataset with lat long coordinates}

database.lat.long <- readr::read_rds("./DATASET.LOCATIONS/database.lat.long.Rds")
```
...
readr::write_rds(temp.precip.values, "./DATASET.LOCATIONS/temp.precip.values.Rds")
```
...
temp.precip.values <- readr::read_rds("./DATASET.LOCATIONS/temp.precip.values.Rds")
```
...
readr::write_rds(SoilGrids.data, "./DATASET.LOCATIONS/SoilGrids.data.Rds")
```

Loading SoilGrids dataset from local disc
```{r Loading SoilGrids dataset}

SoilGrids.data <- readr::read_rds("./DATASET.LOCATIONS/SoilGrids.data.Rds")
```
...
readr::write_rds(merged.database.coords.biophys, "./DATASET.LOCATIONS/merged.database.coords.biophys.Rds")
```
...
database.biopphys <- readr::read_rds("./DATASET.LOCATIONS/merged.database.coords.biophys.Rds")
```
