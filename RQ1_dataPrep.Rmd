...
# --------------------------------------------------------------------------------------------------------------------------
B_SAFTT_ID <- matrix.es.bd.cat.systrait.crop %>%
    dplyr::select(
    "ID.P",
    "ID.S",
...
```{r PLOTTING - selected ecosystem services (including biodiversity and categories data) with crop groups}
E_JOINED_D_C.plot <- E_JOINED_D_C %>%
  ...
  labs(title = "Matrix showing the frequency of associations of crop groups, ecosystem services for different silvoarable systems reported by peer-reviewed papers",
       subtitle = paste("n (individual study sites) = ", n_individual_study_sites),
       caption = paste0("n(independent studies) reporting on biodiversity-related indicators = ", total_n_ES$value),
